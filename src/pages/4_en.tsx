        ...
        <div>
			...
			{step==="process"?
				...
				<div className='main-container-5'>
					...
					<div className='main-des-title-6'><b>Homeowners are RUSHING to Claim their<span style={{backgroundColor:"yellow"}}>Free Solar Panels </span> after the announcement of this 2023 Clean Energy Program</b></div>
