        ...
        <div>
			...
			{step==="process"?
				...
				<div className='main-container'>
					...
					<div className='mian-des-1'>The deadline to lock in your health subsidy ends on <span style = {{fontWeight:"700"}}>February 15th</span>, so call the hotline if you qualify!</div>
