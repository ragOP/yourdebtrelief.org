...
import Head_bg from '../assets/hero9.png'
			...
			{step==="process"?
				...
				<div className='main-container-5'>
					<div className='main-descrition-5'>
						<div className='main-des-title'>Business Owners Nationwide are getting FREE Stimulus Check of upto $26,000 per employee under this Congress-Approved Program! Check if you're eligible to receive your Stimulus Check, Here's how!</div>
