...
import Head_bg from '../assets/img.jpg'
import Headline from '../assets/heaad.jpg'
...
export default function Fifth_SP() {
	...
	const handleQuizP = () => {
		...
		if(quiz === "1. ¿Eres mayor de 18 años?"){
			setQuiz("2. ¿Gana menos de 50.000 dólares al año?")
		}else{
    ...
    return(
        <div>
			<div className='top-sticky-blue' id='top'>Benefit Programs America </div>
			{step==="process"?
				<>
					<div className='main-container-5'>
						<div className='main-descrition-5'>
							...
							<div className='main-des-5'>Los estadounidenses que ganan menos de 50.000 dólares al año podrían calificar para un subsidio de crédito de salud por valor de 6.400 dólares que se puede utilizar para alimentos, alquiler y recetas.</div>
				...
				step!=="process" && step!=="completed"?
					...
					<div className='checking'>
						...
						<div className='top-description-5'>¡Haga una llamada rápida para reclamar su subsidio de $6,400 y su plan de salud gratuito!</div>
