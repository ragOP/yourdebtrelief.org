...
export default function Sixth_SP() {
    ...
    return(
        <div>
			<div className='top-sticky-blue' id='top'>National Debt Relief Program</div>
			{step==="process"?
				<>
					<div className='main-container-5'>
						<div className='main-descrition-5'>
							...
							<div className='main-des-5'>Americans with over $10,000 in dues are receiving a 100% Financial Forgiveness Under This National Debt Relief Program.</div>
